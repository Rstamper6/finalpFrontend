    ...
    <div>
      ...
      >
        ...
        <form onSubmit={onSubmit}>
          <div>
            <Label>Name</Label>
            <Input placeholder="John Smith" value={name} onChange={e => setName(e.target.value)} type='text' />
          </div>
          <div>
            <Label>Date of Birth</Label>
            <Input placeholder="00-00-0000" value={dob} onChange={e => setdob(e.target.value)} type='text' />
          </div>
          <div>
            <Label>Date of Death</Label>
            <Input placeholder="00-00-0000" value={dod} onChange={e => setdod(e.target.value)} type='text' />
          </div>
          <div>
            <Label>Obituary</Label>
            <Input  value={obituary} onChange={e => setObituary(e.target.value)} type='text' />
          </div>
